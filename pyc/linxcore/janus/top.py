...
@module(name="JanusTop")
def build_janus_top(m: Circuit, *, mem_bytes: int = (1 << 20)) -> None:
    clk_top = m.clock("clk")
    rst_top = m.reset("rst")
