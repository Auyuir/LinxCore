...
JANUS_ROOT = ROOT / "pyc" / "linxcore" / "janus"

sys.path.insert(0, str(ROOT / "pyc"))
from linxcore.janus.common.stage_tokens import INTERFACE_PREFIXES, STAGE_TOKENS  # noqa: E402
...
def iter_source_files() -> list[Path]:
    files: list[Path] = []
    for path in JANUS_ROOT.rglob("*.py"):
